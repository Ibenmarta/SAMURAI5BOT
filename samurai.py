...
admin=["ube11adf0f8bfef6fd6b52db6339fd444"] 
owner=["ube11adf0f8bfef6fd6b52db6339fd444"]
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
...
☆ S̡̛͈͇̰̮̞̹̫̣̻͆̽̅̅̽̐̈̂͂A̭͕̭̮̭̞̭͕̝͓͛̎̾̃̓̈́͋́̆͠M̨̫͖̥̣̦̦̝̜̣̄̈́̅̍͗̈́̔͊̍͝Ų̖̜͓̟̭͚̫̦̜̄̒͑͑͐̆̓̽̚͝Ȓ̡͈̗̖̘̺̪̥͖̭͌̊̑͂̀̃̏̕͝Ä̡̡̭̦̮̗̞̟̮̪̃̌̓͂͛̏̿̕͠I̡̨̡̫̦̗͖̲̥͎͐̂͌͛͗͊̉̾͆͝ BOT PROTECT ☆
☆ Destroyers ☆


ADD My Bigboss Kami yg Ganteng Ini Yah All
Idline: http://line.me/ti/p/KAAO5t61bg""",
    "lang":"JP",
              ...
              if msg.from_ in admin:
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 300:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["Mybots"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'ua075d702d0838a2be9231b41cba5b117'}
                cl.sendMessage(msg)

                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u681f6d414d2912e49778a6b735b51513'}
                ki.sendMessage(msg)

                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uf8872fbdaad8230cc0672175ab31da5a'}
                kk.sendMessage(msg)

                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u4ddbf27ba4a0c3adc4c55e16ce1a0302'}
                kc.sendMessage(msg)
                
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'ufa0b3721ec39143535bbaa40a45ebe8b'}
                ks.sendMessage(msg)
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                ...
                else:md+="[•]Comment [Off]\n*============*\n⭐S̹̦͎̼̳̱͇͍̝̰̈́̆͗̈̾̒̚͘͠͠Ȧ̢͕̙͇̦̫̣̪̈́͐̒̎̒̽͋͊͜͝ͅM̧͉͔͉̦̮̣̞̤̖̑͗̈̊̈́̂͐̓̈́͠Ủ͎͓̟̪̗̹̪̗͈̻̈́͌͐̀͂̈́͊͝͠R̡͈̦̖̮͚̰̖̪̹̆͌̉̆́̾̾̎̿̌A̢̧̢̛̫̺͇̯̮̞̮̒̑̈́̏̓͐͐͝I̢̢͚̰͇̟̙̭̅̏̈́̽̓̾͆̉̇̕ͅͅ⭐\n*============*"
...
#---------------------Sc invite owner ke group------
            elif "Undang W: " in msg.text:
              if msg.from_ in owner:
                gid = msg.text.replace("Undang W: ","")
                if gid == "":
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","One piece","All join"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["@bye","Kabur all","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["@Bye 4"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = kc.getGroup(msg.to)
                    gs = ks.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Boss Ini Room apaan?")
                    random.choice(KAC).sendText(msg.to,"Ratain aja lah\nRoom Gaje Kayanya Nih Yah..")
                    random.choice(KAC).sendText(msg.to,"Jangan Kaget Yah;")
                    msg.contentType = 13
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Absen bot","Responsename","Respon"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"SAMURAI 01 On")
                ki.sendText(msg.to,"SAMURAI 02 On")
                kk.sendText(msg.to,"SAMURAI 03 On")
                kc.sendText(msg.to,"SAMURAI 04 On")
                ks.sendText(msg.to,"SAMURAI 05 On")
                cl.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting Sudah Berusaha")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'ube11adf0f8bfef6fd6b52db6339fd444'}
              cl.sendText(msg.to,"======My BigBOSS======")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"=======ALL SAMURAI=======")
              cl.sendText(msg.to,"Itu Creator Kami Yang Ganteng Kak 😜")
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Semoga Diterima Disisinya AMIN :v ")
